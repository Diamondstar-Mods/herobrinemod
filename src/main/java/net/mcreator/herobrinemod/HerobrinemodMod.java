...
import net.mcreator.herobrinemod.init.*;
...
public class HerobrinemodMod {
	public static final Logger LOGGER = LogManager.getLogger(HerobrinemodMod.class);
	public static final String MODID = "herobrinemod";

	public HerobrinemodMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		HerobrinemodModSounds.REGISTRY.register(modEventBus);
		HerobrinemodModBlocks.REGISTRY.register(modEventBus);
		HerobrinemodModItems.REGISTRY.register(modEventBus);
		HerobrinemodModEntities.REGISTRY.register(modEventBus);
		HerobrinemodModTabs.REGISTRY.register(modEventBus);
		HerobrinemodModMenus.REGISTRY.register(modEventBus);
