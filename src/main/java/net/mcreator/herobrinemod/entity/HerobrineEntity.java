...
import net.mcreator.herobrinemod.procedures.HerobrineOnInitialEntitySpawnProcedure;
...
public class HerobrineEntity extends Monster {
	...
	public HerobrineEntity(EntityType<HerobrineEntity> type, Level world) {
		...
		xpReward = 1000;
		setNoAi(false);
		setCustomName(Component.literal("Herpbrine"));
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason reason, @Nullable SpawnGroupData livingdata) {
		...
		HerobrineOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
