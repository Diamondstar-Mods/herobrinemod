...
public class HerobrineDimensionItem extends Item {
	public HerobrineDimensionItem(Item.Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				HerobrineDimensionPortalBlock.portalSpawn(world, pos);
